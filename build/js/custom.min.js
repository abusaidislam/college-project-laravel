  ...
  if (typeof CustomTabs !== "undefined") {
    ...
    TabbedNotification = function (e) {
      ...
      if (document.getElementById("custom_notifications")) {
        ...
        alert("custom_notifications does not exist");
      }
    };
...
function init_charts() {
  try {
    // console.log("run_charts", typeof Chart);
    ...
    console.error("Error in init_charts:", error.message);
  }
}
...
function init_compose() {
  try {
    if (typeof $.fn.slideToggle === "function") {
      ...
      throw new Error("$.fn.slideToggle is not defined");
    }
  } catch (error) {
    console.error("Error in init_compose:", error.message);
  }
}
...
function init_DataTables() {
  try {
    ...
    if (typeof $.fn.DataTable === "undefined") {
      throw new Error("$.fn.DataTable is not defined");
    }
    ...
    console.error("Error in init_DataTables:", error.message);
    // Handle the error as needed, e.g., logging, showing a message, etc.
  }
}

// Call the function to initialize DataTables
init_DataTables();
