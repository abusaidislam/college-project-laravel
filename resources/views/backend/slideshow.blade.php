...
@section('content')
                                        ...
                                        <table id="datatable-responsive"
                                            ...
                                            <tbody id="list">
                                                @foreach ($data as $ndata)
                                                    <td>{{ $ndata->title }}</td>
                                                    <td><img src="{{ asset('public/slide/' . $ndata->image) }} "
                                                            alt="" height="80"> </td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" id="form" name="form" class="form-horizontal"
                                            action="{{ route('slideshow.store') }}" enctype="multipart/form-data">
                                            @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('slideshow.index') }}" + '/' + id + '/edit', function(data) {
