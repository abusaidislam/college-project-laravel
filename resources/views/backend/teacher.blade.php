...
<div class="content">
                                        ...
                                        <tbody id="list">
                                            @foreach ($data as $ndata)
                                                <tr>
                                                    ...
                                                    <td><img src="{{ asset('public/teachers/' . $ndata->photo) }} "
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal modal-lg"
                                        action="{{ route('department-teacher.store') }}" enctype="multipart/form-data">
                                        @csrf()
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">                                     
                                                ...
                                                <div class="form-group">
                                                    <label for="designation" class="col-sm-12 control-label">Home District</label>
                                                    <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="bcs_batch" class="col-sm-12 control-label">BCS_Batch</label>
                                                    <div class="col-sm-12">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="first_joining" class="col-sm-12 control-label">First
                                                        Joining</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="first_joining"
                                                ...
                                                <div class="form-group">
                                                    <label for="present_joining" class="col-sm-12 control-label">Present
                                                        Joining</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="present_joining"
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            ...
            $.get("{{ route('department-teacher.index') }}" + '/' + id + '/edit', function(data) {
                $('#ajaxModel').modal('show');
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'department-teacher/' + id,
                        success: function(data) {
                            window.location = 'department-teacher';
