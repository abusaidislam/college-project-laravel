...
@section('title', 'Mission and Vission Informatio |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Mission and Vission Information</h2>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('degree-mission-vision.store') }}"
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('degree-mission-vision.index') }}" + '/' + id + '/edit', function(data) {
