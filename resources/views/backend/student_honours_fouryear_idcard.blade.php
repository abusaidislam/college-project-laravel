                                ...
                                <div class="business2" style="margin-top: -70px; margin-bottom:-90px">
                                    <div class="front">
                                        <div class="golsap">
                                            ...
                                            <div class="avatars">
                                                <div class="img">
                                                    @if ($stuinfo && $stuinfo->photo)
                                                        <img src="{{ asset('public/student/' . $stuinfo->photo) }}"
                                            ...
                                            <div class="infos">
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p>Blood Group : {{ $stuinfo ? $stuinfo->blood_group : 'N/A' }}
                                                        </p>
                                                        <p>Mobile No : {{ $stuinfo ? $stuinfo->mobile_no : 'N/A' }} </p>
                                                    </div>
                                                </div>
