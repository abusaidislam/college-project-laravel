...
@section('content')
                                            ...
                                            <tbody id="list">
                                                @foreach ($data as $ndata)
                                                    <tr id="row_list{{ $ndata->id }}">
                                                        ...
                                                        <td>{{ $ndata->title }}</td>
                                                        <td>
                                                            <a href="froms/{{ $ndata->id }}" class="btn bt-sm p-1"
                                                                style="background: rgb(148, 249, 15)">
                                                                View
                                                            </a>
                                                            <a href="froms/{{ $ndata->file }}" download class="btn btn-sm"
                                                                style="background: rgb(55, 219, 227)">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" id="form" name="form" class="form-horizontal"
                                            action="{{ route('formsmanage.store') }}" enctype="multipart/form-data">
                                            @csrf()
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="photo" class="col-sm-12 control-label">File</label>
                                                <div class="col-sm-12">
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('formsmanage.index') }}" + '/' + id + '/edit', function(data) {
