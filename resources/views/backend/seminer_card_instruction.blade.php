...
<div class="content">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('seminar-card-instruction.store') }}"
    ...
    <script type="text/javascript">
        ...
        function myFunction() {
            $.get("{{ route('seminar-card-instruction.index') }}" + '/' + id + '/show', function(data1) {
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('seminar-card-instruction.index') }}" + '/' + id + '/edit', function(data) {
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'seminar-card-instruction/' + id,
                        success: function(data) {
                            window.location = 'seminar-card-instruction';
