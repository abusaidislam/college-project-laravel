                ...
                <div class="x_panel">
                                            ...
                                            @foreach ($Student as $ndata)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a target="_blank"
                                                            href="{{ url('degree-third-year-marksheet', $ndata->registration_no) }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('degree-third-year-result.store') }}"
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('degree-third-year-result-list/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
                                        <input type="hidden" name="id" id="id">
                                        <div class="form-group">
                    ...
                    <script type="text/javascript">
                        ...
                        $('body').on('click', '#edit', function() {
                            var id = $(this).data('id');
                            $.get("{{ route('degree-third-year-result.index') }}" + '/' + id + '/edit', function(data) {
