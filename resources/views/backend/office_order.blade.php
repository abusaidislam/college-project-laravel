...
@section('content')
                                        ...
                                        <tbody id="list">
                                            @foreach ($data as $ndata)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="public/upload/{{ $ndata->document }}" download
                                                            class="btn btn-info ">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal modal-lg"
                                        action="{{ route('office_order.store') }}" enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            ...
            $.get("{{ route('office_order.index') }}" + '/' + id + '/edit', function(data) {
                $('#ajaxModel').modal('show');
