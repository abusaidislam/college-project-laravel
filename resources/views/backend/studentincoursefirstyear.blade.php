...
<div class="content">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('first-year-incourse-mark.store') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                            <select class="form-control" id="incourse_type" name="incourse_type" required>
                                                <option class="" value="0" selected>--Select --</option>
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('incourse-first-year-result/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('first-year-incourse-mark.index') }}" + '/' + id + '/edit', function(data) {
