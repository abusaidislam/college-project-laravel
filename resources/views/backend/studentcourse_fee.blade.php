...
@section('title', 'Course Fee Manage |')
@section('content')
<div class="content">
                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        @foreach ($data as $ndata)
                                            <?php
                                                ...
                                                $courseCode = DB::table('course_names')->where('id', $ndata->course_id)->first();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal modal-lg"
                                        action="{{ route('department-course-fee.store') }}" enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            ...
            $.get("{{ route('department-course-fee.index') }}" + '/' + id + '/edit', function(data) {
                $('#ajaxModel').modal('show');
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'department-course-fee/' + id,
                        success: function(data) {
                            window.location = 'department-course-fee';
