@extends('layouts.app')
@section('title', 'Quck links Manage |')
@section('content')
<div class="content">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('qucklinks.store') }}" enctype="multipart/form-data">
                                        @csrf()
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-12 control-label"> Links</label>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="link" value=""
                                                    name="link" placeholder="Enter Links">
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('qucklinks.index') }}" + '/' + id + '/edit', function(data) {
