    ...
    {{-- <div class="right_col" role="main"> --}}
        <style>
            ...
            .pm-certificate-container {
                ...
                border: 2px solid black; /* Added border property */
                padding: 30px;
                font-family: 'Open Sans', sans-serif;
                box-shadow: 0 0 5px rgba(0, 0, 0, .5);
            }
                    ...
                    <div class="row pm-certificate-header">
                        ...
                        <div class="col-md-11 text-center"><br>
                            ...
                            <h3 style="margin-top: 10px">
                                <strong>Department of Degree (pass)</strong>
                            </h3>
                        </div>
                    </div>
                        ...
                        <div class="pm-certificate-block">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 text-center">
                                    <img src="{{ asset('public/Dhead/' . ($degree ? $degree->signature : '')) }}"
                                        alt="" srcset="" width="200" height="40"
                                        style="margin: -30px 0px 0px 0px">

                                    <p>Head of the Department<br>
                                        Department of Degree (pass)<br>
                                        Govt. Saadat College
                                        Karatia, Tangail.
                                    </p>
                                </div>
        ...
        <script>
            document.getElementById('download').addEventListener('click', function() {
                ...
                var options = {
                    margin: 5,
                    filename: 'degree_secondyear_study_certificate.pdf',
                    image: {
                        type: 'jpeg',
                        quality: 0.98
                    },
