                ...
                <div class="x_panel">
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered nowrap"
                                        ...
                                        <tbody id="list">
                                            @foreach ($Student as $ndata)
                                                @php
                                                    // $studentdata = DB::table('students')->where('id', $ndata->stu_id)->first();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a target="_blank"
                                                            href="{{ url('degree-first-year-marksheet', $ndata->registration_no) }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('degree-first-year-result.store') }}"
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('degree-result-list/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
                                        <input type="hidden" name="id" id="id">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-control" id="Session" name="Session">
                                                    ...
                                                    @foreach ($studentSession as $datainfo)
                                                        <option value="{{ $datainfo->session }}">{{ $datainfo->session }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                             </div>
                    ...
                    <script type="text/javascript">
                        ...
                        $('body').on('click', '#edit', function() {
                            var id = $(this).data('id');
                            $.get("{{ route('degree-first-year-result.index') }}" + '/' + id + '/edit', function(data) {
