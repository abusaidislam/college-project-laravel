...
@section('title', 'Student Masters Final InCourse Manage |')
@section('content')
<div class="content">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <h2>Student Masters Final InCourse Information</h2>
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered nowrap"
                                        ...
                                        <tbody id="list">
                                            @foreach ($StudentIncourse as $item)
                                                @php
                                                    $studentdata = DB::table('student_masters_finals')
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('masters-final-incourse-mark.store') }}"
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('incourse-masterfinal-year-result/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('masters-final-incourse-mark.index') }}" + '/' + id + '/edit', function(data) {
