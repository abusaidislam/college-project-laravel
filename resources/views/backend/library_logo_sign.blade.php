...
@section('title', 'Logo & Signature Manage |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Library Logo & Signature Manage</h2>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('library_signature.store') }}" enctype="multipart/form-data">
                                        @csrf()
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="signature" class="col-sm-12 control-label">Librarian Signature
    ...
    <script type="text/javascript">
        ...
        function myFunction() {
            ...
            $.get("{{ route('library_signature.index') }}" + '/' + id + '/show', function(data1) {
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('library_signature.index') }}" + '/' + id + '/edit', function(data) {
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'library_signature/' + id,
                        success: function(data) {
                            window.location = 'library_signature';
