...
@section('title', 'Student Result Second Year Manage |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Student Result Second Year</h2>
                                            ...
                                            @foreach ($Student as $ndata)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a target="_blank"
                                                            href="{{ url('secound-year-marksheet', $ndata->registration_no) }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('students-result-second-year.store') }}"
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('students-result-second-year.index') }}" + '/' + id + '/edit', function(data) {
