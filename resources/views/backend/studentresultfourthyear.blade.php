...
@section('title', 'Student Result Fourth Year Manage |')
@section('content')
<div class="content">
                                            ...
                                            @foreach ($Student as $ndata)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a target="_blank"
                                                            href="{{ url('fourth-year-marksheet', $ndata->registration_no) }}"
                                                            class="btn btn-sm btn-primary">View Result</a>
                                                        <a target="_blank"
                                                            href="{{ url('consolidated-result', $ndata->registration_no) }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('students-result-fourth-year.store') }}"
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('students-result-fourth-year.index') }}" + '/' + id + '/edit', function(data) {
