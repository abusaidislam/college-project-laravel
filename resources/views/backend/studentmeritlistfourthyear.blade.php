        ...
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <h2>Student Fourth Year Merti Information</h2>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('fourth-year-merit-list.store') }}" enctype="multipart/form-data">
                                        @csrf()
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('fourth-year-merit-list/export-pdf') }}"
                    ...
                    <script type="text/javascript">
                        ...
                        $('body').on('click', '#edit', function() {
                            var id = $(this).data('id');
                            $.get("{{ route('fourth-year-merit-list.index') }}" + '/' + id + '/edit', function(data) {
