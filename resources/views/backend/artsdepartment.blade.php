...
<div class="modal fade" id="ajaxModel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="form" name="form" class="form-horizontal" action="{{ route('artsdepartment.store') }}"  enctype="multipart/form-data">
                    @csrf()
  ...
  <input type="hidden" name="id" id="id">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="name" name="name" placeholder="Department Name" value="" required="">
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
           ...
           function myFunction() {
               ...
               $.get("{{ route('artsdepartment.index') }}" +'/' + id +'/show', function (data1) { 
           ...
           $('body').on('click', '#edit', function () {
             ...
             $.get("{{ route('artsdepartment.index') }}" +'/' + id +'/edit', function (data) {
 ...
 if (confirm("Are You sure want to delete This!")) {
        $.ajax({
                   type: "DELETE",
                   url:'artsdepartment/'+id ,
                   success: function (data) {
                       window.location='artsdepartment'
                   }
