...
@section('title', 'Sports Teacher Manage |')
@section('content')
...
<div class="content">
                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <tbody id="list">
                                            @foreach ($data as $ndata)
                                                <tr>
                                                    <td><img src="{{ asset('public/sportsteacher/' . $ndata->photo) }} "
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal modal-lg"
                                        action="{{ route('sportsteacherlist.store') }}" enctype="multipart/form-data">
                                        @csrf()
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="first_join"
                                                    name="first_join" placeholder="Enter First Joining" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="present_join"
                                                    name="present_join" placeholder="Enter Present Joining"
                                                    required="">
                                            </div>
                                        </div>
                                        <div id="img"></div>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('sportsteacherlist.index') }}" + '/' + id + '/edit', function(data) {
                $('#ajaxModel').modal('show');
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'sportsteacherlist/' + id,
                        success: function(data) {
                            window.location = 'sportsteacherlist';
