...
<div class="content">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('cinstruction.store') }}" enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        function myFunction() {
            ...
            $.get("{{ route('cinstruction.index') }}" + '/' + id + '/show', function(data1) {
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('cinstruction.index') }}" + '/' + id + '/edit', function(data) {
