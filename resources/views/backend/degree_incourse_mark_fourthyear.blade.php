        ...
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <h2>Student Fourth Year InCourse Information</h2>
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered nowrap"
                                        ...
                                        <tbody id="list">
                                            @foreach ($StudentIncourse as $item)
                                                {{-- @dd($item); --}}
                                                @php
                                                    $studentdata = DB::table('degree_fourth_year_students')
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item->written1st_marks }}
                                                    </td>
                                                    <td>{{ $item->atten1st_marks }}
                                                    </td>
                                                    <td>{{ $item->total1st_result }}
                                                    </td>
                                                    <td>{{ $item->written2nd_marks }}
                                                    </td>
                                                    <td>{{ $item->atten2nd_marks }}
                                                    </td>
                                                    <td>{{ $item->total2nd_result }}
                                                    </td>
                                                    <td style="background: rgb(63, 235, 63)">{{ $max }}
                                                    </td>
                                                    <td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('degree-fourth-year-incourse-mark.store') }}"
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('degree-fourth-incourse-result/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
                                        <input type="hidden" name="id" id="id">
                                        <div class="form-group">
                    ...
                    <script type="text/javascript">
                        ...
                        $('body').on('click', '#edit', function() {
                            var id = $(this).data('id');
                            $.get("{{ route('degree-fourth-year-incourse-mark.index') }}" + '/' + id + '/edit', function(data) {
