@extends('layouts.app')
@section('title', 'Elearning Notice Manage |')
@section('content')
<div class="content">
                                            ...
                                            @foreach ($data as $ndata)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ asset('public/elearning_notice/' . $ndata->file) }}" download
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('elearning-notice.store') }}" enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('elearning-notice.index') }}" + '/' + id + '/edit', function(data) {
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'elearning-notice/' + id,
                        success: function(data) {
                            window.location = 'elearning-notice';
