            ...
            <div class="mt-5" style="    background: #b5a3a312; padding: 10px; border: 12px red;">
                ...
                <div class="row mt-1 ">
                    ...
                    <div class="col-md-9 text-center" style="margin-top: -30px">
                        ...
                        <p class="mb-0">
                            <span style="font-family:Arial; font-size:15pt">Degree Examination
                                {{ $examyear->years ?? '' }}</span>
                        </p>
                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                @php
                                    $totalCredit = $firstYearCredit + $secondYearCredit + $thirdYearCredit;
                                    $totalGpa = number_format($firstYearSum + $secondYearSum + $thirdYearSum, 2);
                                    $Totalcgpa = $totalGpa / $totalCredit;
                                @endphp
                                <tr>
                                    <td><strong>Result</strong></td>
                                    @if ($firstYearGpa || $secondYearGpa || $thirdYearGpa)
                ...
                <div class="row" style="font-size: 13px">
                    <div class="col-md-4" style="margin-right: -22px; margin-left:20px">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                    ...
                    <div class="col-md-4" style="margin-right: -22px">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
