...
@section('title', 'Degree Secound Year Student Manage |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Degree Secound Year Student Information</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li>
                                <span class="input-group-btn">
                                    <a class="btn btn-success" href="javascript:void(0)" id="createNew1">2nd Year Student Import</a>
                                 </span>
                            </li>
                            <li>
                                <span class="input-group-btn">
                                                ...
                                                <tr>
                                                    ...
                                                    @if ($ndata)
                                                        ...
                                                        <td><button type="button" id="edit"
                                                            ...
                                                            <a href="{{ url('degree_secondyear_idcard', $ndata->id) }}"
                                                                class="btn btn-sm" style="background: rgb(125, 255, 4)">ID
                                                                Card</a>
                                                            <a href="{{ url('degree_secondyear_studycertificate', $ndata->id) }}"
                                                                class="btn btn-sm"
                                                    ...
                                                    @else
                                                        ...
                                                        <td><button type="button" id="edit"
                                                            ...
                                                            <button type="button" id="delete"
                                                                data-id="{{ $item->id }}"
                                                                class="btn btn-sm btn-danger">Delete</button>
                                                            <a href="{{ url('degree_secondyear_idcard', $item->id) }}"
                                                                class="btn btn-sm" style="background: rgb(125, 255, 4)">ID
                                                                Card</a>
                                                            <a href="{{ url('degree_secondyear_studycertificate', $item->id) }}"
                                                                class="btn btn-sm"
                                                                style="background: rgb(4, 238, 255)">Study
                                                                Certificate</a>
                                                        </td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('degree-secound-year-students.store') }}"
                    ...
                    <div class="modal fade" id="ajaxModel1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('degree_scound_year_import') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                    ...
                    <div class="modal fade" id="ajaxModel2" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('degree_second_year_idcard') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                    ...
                    <div class="modal fade" id="ajaxModel3" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('degree_secondyear_student_promote') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="file" class="col-sm-12 control-label">Session</label>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            console.log(id);
            $.get("{{ route('degree-secound-year-students.index') }}" + '/' + id + '/edit', function(data) {
                console.log(data);
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'degree-secound-year-students/' + id,
                        success: function(data) {
                            window.location = 'degree-secound-year-students';
