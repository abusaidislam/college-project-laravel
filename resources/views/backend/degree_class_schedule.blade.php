...
@section('title', 'Class Schedule Manage |')
@section('content')
<div class="content">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ Route('degree-class_schedules.store') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="day" name="day" pl
                                                            class="form-control" aceholder="Day Name" value=""
                                                            required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="name"
                                                        class="col-sm-12 control-label">9.45--10.30</label>
                                                    <div class="col-sm-12">
                                                        <textarea id="scend" name="scend"
                                                            class="form-control"> </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-12 control-label"> 10.30--11.15
                                                    </label>
                                                    <div class="col-sm-12">
                                                        <textarea id="third" name="third"
                                                            class="form-control"> </textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="name"
                                                        class="col-sm-12 control-label">11.15--12.00</label>
                                                    <div class="col-sm-12">
                                                        <textarea id="forth" name="forth"
                                                            class="form-control"> </textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label for="name"
                                                        class="col-sm-12 control-label">12.00--12.45</label>
                                                    <div class="col-sm-12">
                                                        <textarea id="fifth" name="fifth"
                                                            class="form-control"> </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name"
                                                        class="col-sm-12 control-label">12.45--1.30</label>
                                                    <div class="col-sm-12">
                                                        <textarea id="sixth" name="sixth"
                                                            class="form-control"> </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-12 control-label">
                                                        1.30--2.00</label>
                                                    <div class="col-sm-12">
                                                        <textarea id="seventh" name="seventh"
                                                            class="form-control"> </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ Route('degree-class_schedules.index') }}" + '/' + id + '/edit', function(data) {
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'degree-class_schedules/' + id,
                        success: function(data) {
                            window.location = 'degree-class_schedules';
