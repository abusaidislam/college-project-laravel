@extends('layouts.app')
@section('title', 'NIS Notice Manage |')
@section('content')
<div class="content">
                                        ...
                                        <tbody id="list">
                                            @foreach ($data as $ndata)
                                                <tr>
                                                    ...
                                                    <td>{{ $ndata->title }}</td>
                                                    <td>
                                                        <a href="{{ asset('public/nisnotice/' . $ndata->file) }}" download
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('nis-notice.store') }}" enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('nis-notice.index') }}" + '/' + id + '/edit', function(data) {
