...
@section('title', 'Student Secound Year InCourse Manage |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Student Secound Year InCourse Information</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li>
                                <span class="input-group-btn">
                                    <a class="btn btn-primary " href="javascript:void(0)" id="exprotModel">Incourse
                                        Result
                                        PDF
                                    </a>
                                </span>
                                ...
                                <div class="card-box table-responsive">
                                    <table id="datatable-responsive" class="table table-striped table-bordered nowrap"
                                        ...
                                        <tbody id="list">
                                            ...
                                            @php
                                            $studentdata = DB::table('degree_secound_year_students')
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $item->course_code }}
                                                </td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('degree-second-year-incourse-mark.store') }}"
                                        ...
                                        <div class="form-group">
                                            <label for="student_class_year"
                                                class="col-sm-12 control-label">Session</label>
                                                <div class="col-sm-12">
                                                <select class="form-control" id="student_class_year"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-control" id="year" name="year" required>
                                                    ...
                                                    $currentYear = date('Y');
                                                    @endphp
                                                    @for ($i = 2000; $i < 2050; $i++) <option value="{{ $i }}" {{
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('degree-secound-incourse-result/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
                                        <input type="hidden" name="id" id="id">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="classSession" class="col-sm-12 control-label">Session</label>
                                            <div class="col-sm-12">
...
<script type="text/javascript">
    $(document).ready(function() {
                        ...
                        $('body').on('click', '#edit', function() {
                            var id = $(this).data('id');
                            $.get("{{ route('degree-second-year-incourse-mark.index') }}" + '/' + id + '/edit', function(data) {
