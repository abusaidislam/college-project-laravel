                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal modal-lg"
                                        action="{{ route('degree-notice.store') }}" enctype="multipart/form-data">
                                        @csrf()
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea class="summernote " id="details" name="details"
                                                    placeholder="Enter Details" value=""></textarea>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on('click', '#edit', function() {
            ...
            $.get("{{ route('degree-notice.index') }}" + '/' + id + '/edit', function(data) {
                $('#ajaxModel').modal('show');
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'degree-notice/' + id,
                        success: function(data) {
                            window.location = 'degree-notice';
