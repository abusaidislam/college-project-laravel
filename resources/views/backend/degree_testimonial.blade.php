    ...
    {{-- <div class="right_col" role="main"> --}}
        <style>
            ...
            .pm-certificate-container {
                ...
                background-image: url('{{ asset('public/tetimonialjolshap/16de.jpg') }}');
                    ...
                    <div class="row" style="margin-top: -275px">
                        <div class="pm-certificate-block">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12 text-justify">
                                    <span class="block cursive" style="font-size: 14px; line-height:2;">This is to certify
                                        ...
                                        <b>{{ $studentdata->father_name ?? '....................................' }}
                                        </b>
                                        and <b>{{ $studentdata->mather_name ?? '....................................' }},
                                        </b>
                                        ...
                                        had been a student of the <b>Departmet of Degree,
                                        </b>
                                        Govt. Saadat College, Karatia, Tangail.
                                        {{ $ndata->gender == 'Male' ? 'He' : 'She' }} Passed the
                                        <b>Degree</b> Examination in <b>Degree (pass)</b> in
                                        <b>{{ $endYear ?? '.........' }}</b>
                                        under National
                                        University held in
                                        <b>{{ $ndata->held_year ?? '...............' }}</b>.
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 text-center">
                                    <img src="{{ asset('public/library_card/' . $basic->signature) }}" alt=""
                                        srcset="" width="200" height="40" style="margin: -30px 0px 0px 0px">
                                    <p>Principal <br>
        ...
        <script>
            document.getElementById('download').addEventListener('click', function() {
                ...
                var options = {
                    margin: 5,
                    filename: 'degree_testimonial.pdf',
                    image: {
                        type: 'jpeg',
                        quality: 0.98
                    },
