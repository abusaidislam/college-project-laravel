...
<div class="page-title">
    ...
    @foreach ($data as $ndata)
                        <tr>
                        <td><img src="{{asset('sportsteacher/'.$ndata->photo)}} " alt="" width="80" height="80">  </td>
                        <td>{{$ndata->name}}</td>
                        <td>{{$ndata->email}}  </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="form" name="form" class="form-horizontal modal-lg" action="{{ route('sportsteacherlist.store') }}"  enctype="multipart/form-data">
                        @csrf()
