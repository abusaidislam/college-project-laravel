...
@section('title', 'Student Fourth Year InCourse Manage |')
@section('content')
<div class="content">
                                    ...
                                    <table id="datatable-responsive" class="table table-striped table-bordered nowrap"
                                        ...
                                        <tbody id="list">
                                            @foreach ($StudentIncourse as $item)
                                                @php
                                                    $studentdata = DB::table('student_honours_fourth_years')
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('fourth-year-incourse-mark.store') }}"
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('incourse-fourth-year-result/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('fourth-year-incourse-mark.index') }}" + '/' + id + '/edit', function(data) {
        ...
        $('#classId').on('change', function() {
            var id = $(this).val();
            $.ajax({
                url: 'student_fourth_year_session/' + id,
                type: 'GET',
                dataType: 'json',
            ...
            if (len > 0) {
                for (var i = 0; i < len; i++) {
                    ...
                    var tr_str = "<tr>" +
                        ...
                        " ><td align='center'><input type='text' class='form-control' id='marks' name='marks[]' placeholder='Enter Attendance Number ' value='' required=''></td></tr>";
