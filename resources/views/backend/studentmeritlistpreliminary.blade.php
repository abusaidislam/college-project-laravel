        ...
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        <h2>Student Preliminary To Masters Merti Information</h2>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('preliminary-merit-list.store') }}" enctype="multipart/form-data">
                                        @csrf()
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('preliminary-merit-list/export-pdf') }}"
                    ...
                    <script type="text/javascript">
                        ...
                        $('body').on('click', '#edit', function() {
                            var id = $(this).data('id');
                            $.get("{{ route('preliminary-merit-list.index') }}" + '/' + id + '/edit', function(data) {
