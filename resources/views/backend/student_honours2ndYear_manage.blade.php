...
@section('title', 'Honours Secound Year Student Manage |')
@section('content')
<div class="content">
      <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Honours Secound Year Student</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li>
                                <span class="input-group-btn">
                                    <a class="btn btn-success" href="javascript:void(0)" id="createNew1">2nd Year Student Import
                                    </a>
                                </span>
                            </li>
                            <li>
                                                ...
                                                <tr>
                                                    ...
                                                    @if ($ndata)
                                                        ...
                                                        <td><button type="button" id="edit"
                                                            ...
                                                            <a href="{{ url('second_year_student_idcard', $item->id) }}"
                                                                class="btn btn-sm" style="background: rgb(125, 255, 4)">ID
                                                                Card</a>
                                                            <a href="{{ url('honors_secondyear_studycertificate', $item->id) }}"
                                                                class="btn btn-sm"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('honours-secound-year-students.store') }}"
                    ...
                    <div class="modal fade" id="ajaxModel1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('scound_student_import') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                    ...
                    <div class="modal fade" id="ajaxModel2" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('honours_second_year_idcard') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                    ...
                    <div class="modal fade" id="ajaxModel3" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('honours_third_student_promote') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="file" class="col-sm-12 control-label">Session</label>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            console.log(id);
            $.get("{{ route('honours-secound-year-students.index') }}" + '/' + id + '/edit', function(data) {
                console.log(data);
        ...
        $('body').on('click', '#delete', function() {
                    ...
                    Swal.fire(sweetAlertConfirmation).then((result) => {
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "DELETE",
                                url: 'honours-secound-year-students/' + id,
                                success: function(data) {
                                    window.location = 'honours-secound-year-students';
