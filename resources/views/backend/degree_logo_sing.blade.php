...
@section('title', 'Degree Logo & Signature Manage |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Degree Logo & Signature Manage</h2>
                                        ...
                                        <tbody id="list">
                                            ...
                                            <tr>
                                                ...
                                                <td><button type="button" id="edit" data-id="{{ $ndata->id }}"
                                                        class="btn btn-sm btn-info"><span class="">Edit</span></button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('degree_logo_sign.store') }}" enctype="multipart/form-data">
                                        @csrf()
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function myFunction() {
            ...
            $.get("{{ route('degree_logo_sign.index') }}" + '/' + id + '/show', function(data1) {
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('degree_logo_sign.index') }}" + '/' + id + '/edit', function(data) {
