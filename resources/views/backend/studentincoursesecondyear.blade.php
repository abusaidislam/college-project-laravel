...
@section('title', 'Student Second Year InCourse Manage |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Student Second Year InCourse Information</h2>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('second-year-incourse-mark.store') }}"
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('incourse-second-year-result/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('second-year-incourse-mark.index') }}" + '/' + id + '/edit', function(data) {
        ...
        $('#classId').on('change', function() {
            ...
            console.log(id);
            $.ajax({
                url: 'student_secoundyear_session/' + id,
                type: 'GET',
                dataType: 'json',
