    ...
    {{-- <div class="right_col" role="main"> --}}
            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <span class="input-group-btn" style="margin-top:-100px; margin-left:15px">
                            <a class="btn btn-sm btn-success" href="javascript:void(0)" id="download"><i class="fa fa-download"
                                    style="font-size:16px"> Download</i></a>
                        </span><br>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="business2" style="margin-top: -70px; margin-bottom:-90px">
                                <div class="front">
                                    <div class="golsap">
                                        ...
                                        <div class="avatars">
                                            <div class="img">
                                                <img src="{{ asset('public/hostel_card/' . $ndata->photo) }}" alt=""
                                        ...
                                        <div class="avatersname">
                                            <p>{{ $info ? $info->student_name : '' }}</p>
                                            <p> <span style="border-bottom: 2px solid black">HOSTEL ID CARD</span></p>
                                        </div>
                                        <div class="infos">
                                            <div>
                                                ...
                                                <div>
                                                    ...
                                                    <p>Roll/Reg : {{ $ndata->roll }}/{{ $ndata->registration }}</p>
                                                    <p>Dept : {{ $ndata->deprartment }}</p>
                                                    <p>Class : {{ $ndata->year }}</p>
                                                    <p>Mobile: {{ $ndata->mobile_no }}, Bl:
                                                        {{ $ndata->blood_group }}</p>
                                                    <p>Bulding: {{ $ndata->bulding_name }}</p>
                                                    <p>Floor: {{ $ndata->floor_name }}, Room:
                                                        {{ $ndata->room_number }}</p>
                                                    <p>Seat Num : {{ $ndata->seat_number }}</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="top">
                                        <div>
                                            ...
                                            @foreach ($data as $idata)
                                                <P>{{ $idata->idcard_note }}</P>
                                            @endforeach
                                        </div>
                                    </div>
                                    <?php
                                    $startDate = new DateTime($info->check_in_date);
                                    $endDate = $startDate->modify('+1 year');
                                    ?>

                                    <div class="date">
                                        <p>Create Date : {{ $info->check_in_date }} <br>
                                            Expire Date : {{ $endDate->format('Y-m-d') }}
                                        </p>
                                    </div>
                                    <div class="sing">
        ...
        <script>
            document.getElementById('download').addEventListener('click', function() {
                ...
                var element = document.querySelector('.hostelidcard');
