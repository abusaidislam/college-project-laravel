...
@section('title', 'Teachers Honour Board Information |')
@section('content')
<div class="content">
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            ...
            $.get("{{ route('teacher-honour-board') }}" + '/' + id + '/edit', function(data) {
                $('#ajaxModel').modal('show');
        ...
        $('body').on('click', '#delete', function() {
            ...
            if (confirm("Are You sure want to delete This!")) {
                $.ajax({
                    type: "DELETE",
                    url: 'teacher-honour-board/' + id,
                    success: function(data) {
                        window.location = 'teacher-honour-board'
                    }
