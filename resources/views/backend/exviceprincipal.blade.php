...
@section('title', 'Vice-Principal Honour Board Manage |')
@section('content')
<div class="content">
      <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Vice-Principal Honour Board Information</h2>
                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <tbody id="list">
                                            @foreach ($data as $ndata)
                                                <tr class="text-center">
                                                    <td><img src="{{ asset('public/viceprincipal/' . $ndata->photo) }} "
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('exviceprincipal.store') }}" enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('exviceprincipal.index') }}" + '/' + id + '/edit', function(data) {
        ...
        $('body').on('click', '#delete', function() {
            ...
            if (confirm("Are You sure want to delete This!")) {
                $.ajax({
                    type: "DELETE",
                    url: 'exviceprincipal/' + id,
                    success: function(data) {
                        window.location = 'exviceprincipal'
                    }
