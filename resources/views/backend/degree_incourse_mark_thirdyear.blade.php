                                ...
                                <div class="card-box table-responsive">
                                    <table id="datatable-responsive" class="table table-striped table-bordered nowrap"
                                        ...
                                        <tbody id="list">
                                            ...
                                            @php
                                            $studentdata = DB::table('degree_third_year_students')
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('degree-third-year-incourse-mark.store') }}"
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('degree-third-incourse-result/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
                                        <input type="hidden" name="id" id="id">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-control" id="classSession" name="classSession" required>
                                                    <option class="" value="0" selected>--Select --</option>
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        $('body').on('click', '#edit', function() {
                            var id = $(this).data('id');
                            $.get("{{ route('degree-third-year-incourse-mark.index') }}" + '/' + id + '/edit', function(data) {
