...
@section('title', 'Student First Year InCourse Manage |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Student First Year InCourse Information</h2>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('degree-first-year-incourse-mark.store') }}"
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('degree-first-incourse-result/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
                                        <input type="hidden" name="id" id="id">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-control" id="classSession" name="classSession"
                                                    ...
                                                    <option value="{{ $item->session }}">{{ $item->session }}
                                                        @endforeach
                                                    </option>
                                                </select>
                                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
                        ...
                        $('body').on('click', '#edit', function() {
                            var id = $(this).data('id');
                            $.get("{{ route('degree-first-year-incourse-mark.index') }}" + '/' + id + '/edit', function(data) {
