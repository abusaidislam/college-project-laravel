...
@section('content')
                                            ...
                                            <tbody id="list">
                                                @foreach ($data as $ndata)
                                                    <tr>
                                                        ...
                                                        <td>{{ $ndata->title }}</td>
                                                        <td>{{ $ndata->route }} </td>
                                                        <td><img src="{{ asset('public/Menu/' . $ndata->image) }} "
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" id="form" name="form" class="form-horizontal"
                                    action="{{ route('menumanage.store') }}" enctype="multipart/form-data">
                                    @csrf()
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="name" name="name"
                                                placeholder="Menu Name" value="" maxlength="50" required="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="route" class="col-sm-12 control-label">Menu Route</label>
                                        <div class="col-sm-12">
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('menumanage.index') }}" + '/' + id + '/edit', function(data) {
