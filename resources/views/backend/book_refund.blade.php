...
@section('title', 'Book Refund with Fine Manage |')
@section('content')
<div class="content">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li>
                                <span class="input-group-btn">
                                    <a class="btn btn-primary" href="{{ url('/generate-pdf') }}" id=""> Download PDF </a>
                                </span>
                            </li>
                        </ul>
                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Comments</th>
                                                <th width="280px" class="action-column">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody id="list">
                                            @foreach ($datareturnd as $ndata)
                                                @php
                                                    $cardNumber = DB::table('library_cards')
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="action-column"><button type="button" id="edit"
                                                            data-id="{{ $ndata->id }}" class="btn btn-sm btn-info"><span
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('refund.store') }}" enctype="multipart/form-data">
                                        @csrf()
                                            ...
                                            <div class="col-sm-12">
                                                <select class="js-select2" name="card_id" id="card_id">
                                                    <option class="" value="0" selected>--Select Library Card No.
                                                        --</option>
                                                    @php
                                                        $uniqueCardNos = DB::table('book_issues')
                                                            ->distinct()
                                                            ->pluck('card_no');
                                                    @endphp
                                                    ...
                                                    @foreach ($uniqueCardNos as $cardNo)
                                                        @php
                                                            $cardInfo = DB::table('library_cards')
                                                                ->where('id', $cardNo)
                                                                ->first();
                                                        @endphp
                                                        <option value="{{ $cardInfo ? $cardInfo->id : '' }}">
                                                            {{ $cardInfo ? $cardInfo->card_no : '' }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea class="summernote" placeholder="Enter Details" id="comment"name="comment"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                  </div>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('refund.index') }}" + '/' + id + '/edit', function(data) {
                // console.log(data);
