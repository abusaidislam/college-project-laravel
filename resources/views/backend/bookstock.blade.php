...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2 id="headdingtext">Book Stock</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li>
                                <span class="input-group-btn">
                                    <a class="btn btn-primary" href="{{ url('/book_stock_pdf') }}" id=""> Download PDF
                                    </a>
                                </span>
                            </li>
                        </ul>
                                            ...
                                            @foreach ($data as $ndata)
                                                @php
                                                    $bookissues = DB::table('book_issues')
                                                        ...
                                                        ->get();
                                                    // $booksrefund = DB::table('book_refunds')
                                                    //     ->where('book_id', $ndata->id)
                                                    //     ->get();
                                                    $booksrefund = DB::table('book_refunds')
                                                        ->Join('book_issues', 'book_issues.date_of_return_book', '=', 'book_refunds.date_of_return')
                                                        ->where('book_refunds.book_id', $ndata->id)
                                                        ->get();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('bookstock.store') }}" enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('bookstock.index') }}" + '/' + id + '/edit', function(data) {
