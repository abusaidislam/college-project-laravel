...
@section('title', 'Seminar Book Issue Manage |')
@section('content')
<div class="content">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li>
                                 <span class="input-group-btn">
                                    <a class="btn btn-primary" href="{{ url('/seminar_book_issue_pdf') }}" id=""> Download PDF
                                    </a>
                               </span>
                            </li>
                        </ul>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('seminar-book-issue.store') }}" enctype="multipart/form-data">
                                        @csrf()
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('seminar-book-issue.index') }}" + '/' + id + '/edit', function(data) {
                console.log(data);
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'seminar-book-issue/' + id,
                        success: function(data) {
                            window.location = 'seminar-book-issue';
