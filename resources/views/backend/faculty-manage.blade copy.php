                ...
                <tbody id="list">
                    @foreach ($data as $basic)
                        <tr id="row_list{{$basic->id}}">
                            ...
                            <td>{{$basic->name}}</td>                    
                            <td>
                                <button type="button" id="edit" data-id="{{$basic->id}}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" id="form" name="form" class="form-horizontal" action="{{ route('faculty.store') }}"  enctype="multipart/form-data">
                            @csrf()
                            <input type="hidden" name="id" id="id">
                            <div class="form-group">
                                <label for="name" class="col-sm-4 control-label">Faculty Name</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter Faculty Name" value="" maxlength="50" required="">
                                </div>
                            </div>
