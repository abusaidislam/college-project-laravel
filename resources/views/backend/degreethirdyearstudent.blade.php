...
@section('title', 'Degree Third Year Student Manage |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Degree Third Year Student Information</h2>
                                                ...
                                                <tr>
                                                    ...
                                                    @if ($ndata)
                                                        ...
                                                        <td><button type="button" id="edit"
                                                            ...
                                                            <a href="{{ url('degree_thirdyear_idcard', $ndata->id) }}"
                                                                class="btn btn-sm" style="background: rgb(125, 255, 4)">ID
                                                                Card</a>
                                                            <a href="{{ url('degree_thirdyear_studycertificate', $ndata->id) }}"
                                                                class="btn btn-sm"
                                                            ...
                                                            <a href="{{ url('degree_testimonial', $item->id) }}"
                                                                class="btn btn-sm"
                                                    ...
                                                    @else
                                                        ...
                                                        <td class="bg-danger text-white">No data found Because</td>
                                                        <td class="bg-danger text-white">This Student No Insert!!!
                                                        </td>
                                                        ...
                                                        <td><button type="button" id="edit"
                                                            ...
                                                            <button type="button" id="delete"
                                                                data-id="{{ $item->id }}"
                                                                class="btn btn-sm btn-danger">Delete</button>
                                                            <a href="{{ url('degree_thirdyear_idcard', $item->id) }}"
                                                                class="btn btn-sm" style="background: rgb(125, 255, 4)">ID
                                                                Card</a>
                                                            <a href="{{ url('degree_thirdyear_studycertificate', $item->id) }}"
                                                                class="btn btn-sm"
                                                                style="background: rgb(4, 238, 255)">Study
                                                                Certificate</a>
                                                            <button type="button" id="edit2"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('degree-third-year-students.store') }}"
                    ...
                    <div class="modal fade" id="ajaxModelcgpa" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="modelHeading"></h4>
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        ...
                                        <div class=" col-sm-offset-2 col-sm-10 my-2">
                                            ...
                                            <button type="button" class="btn btn-danger" id="closemodalcgpa"
                                                aria-label="Close">
                                                close
                                            </button>
                                        </div>
                    ...
                    <div class="modal fade" id="ajaxModel1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('degree_third_year_import') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                    ...
                    <div class="modal fade" id="ajaxModel2" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('degree_third_year_idcard') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="file" class="col-sm-12 control-label">Session</label>
                                            <div class="col-sm-12 mb-4">
                                                <select class="form-control select2" id="studentsession" name="studentsession">
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('degree-third-year-students.index') }}" + '/' + id + '/edit', function(data) {
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'degree-third-year-students/' + id,
                        success: function(data) {
                            window.location = 'degree-third-year-students';
    ...
    <script type="text/javascript">
        ...
        $('#closemodalcgpa').click(function() {
            $('#ajaxModelcgpa').modal('hide');
        });
