            ...
            <style>
                ...
                * {
                ...
                .business2 .front {
                    ...
                    overflow: hidden;
                    position: relative;
                    background-image: url('{{ asset('public/library_card/ssas.jpg') }}');
                ...
                .business2 .back {
                    ...
                    overflow: hidden;
                    position: relative;
                    background-image: url('{{ asset('public/library_card/sss.jpg') }}');
                    background-size: cover;
                    background-position: center;
                            ...
                            <div class="x_content sssss">
                                ...
                                <div class="business2" style="margin-top: -70px; margin-bottom:-90px">
                                    <div class="front">
                                        <div class="golsap">
                                            ...
                                            <div class="avatersname">
                                                ...
                                                <p> <span style="border-bottom: 2px solid black">LIBRARY ID CARD</span></p>
                                            </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        @if ($ndata->department_id == '40')
                                                            ...
                                                            <p>Class :{{ $degreeClass ? $degreeClass->name : '' }}</p>
                                    ...
                                    <div class="back">
                                        ...
                                        ?>
                                        <div class="date">
                                            <p>Create Date : {{ $ndata ? $ndata->date : '' }} <br>
