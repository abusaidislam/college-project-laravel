...
@section('title', 'Student Result Masters Final Manage |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Student Result Masters Final</h2>
                                            ...
                                            @foreach ($Student as $ndata)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a target="_blank"
                                                            href="{{ url('masters-final-marksheet', $ndata->registration_no) }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('masters-final-result.store') }}" enctype="multipart/form-data">
                                        @csrf()
...
<script type="text/javascript">
    ...
    $('body').on('click', '#edit', function() {
        var id = $(this).data('id');
        $.get("{{ route('masters-final-result.index') }}" + '/' + id + '/edit', function(data) {
