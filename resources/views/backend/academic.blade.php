              ...
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody >
                    @foreach ($data as $ndata)
                        <tr >
                        <td>{{$ndata->title}}</td>
                        <td><a  href="{{$ndata->details}}" class="btn btn-info "><img src="{{$ndata->details}} " alt="" width="80" height="80"> </a> </td>
...
<div class="modal fade" id="ajaxModel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="form" name="form" class="form-horizontal" action="{{ route('academicmanage.store') }}"  enctype="multipart/form-data">
                    @csrf()
  ...
  <input type="hidden" name="id" id="id">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="file" class="form-control" id="description" name="photo" placeholder="Enter Description" value=""  >
                    ...
                    <div class=" col-sm-offset-2 col-sm-10 my-2">
                     ...
                     <button type="submit" class="btn btn-primary" id="saveBtn" ></button>
                      <button type="button" class="btn btn-danger "  id="close" data-bs-dismiss="modal" aria-label="Close">Close</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
           ...
           $('body').on('click', '#edit', function () {
             var id = $(this).data('id');
             $.get("{{ route('academicmanage.index') }}" +'/' + id +'/edit', function (data) {
