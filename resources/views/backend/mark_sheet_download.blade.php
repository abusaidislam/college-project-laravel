...
<body class="" style="font-family:'Times New Roman'; font-size:12pt; width:940px; margin:auto; border:">
    ...
    <div class="containers p-4" style="margin-top: -40px">
        ...
        <div class="">
            <div class="mt-5" style="background: #b5a3a312; padding: 10px; border: 5px double rgba(0, 0, 0, 0.2);">
                {{-- <div class="mt-4"> --}}
                <div class="row mt-5">
                ...
                <div class="row mt-1 p-3 ">
                    ...
                    <div class="col-md-9 col-sm-9 text-center" style="margin-top: -20px">
                        ...
                        @php
                            $examdata = DB::table('studen_classes')
                                ->where('id', 1)
                                ->first();
                        @endphp
                        <p class="mb-0">
                            ...
                            <tr style="height:21.85pt; -aw-height-rule:exactly">
                                <td colspan="5"
                                    ...
                                    <p
                                        ...
                                        <span style="font-family:Arial; font-size:11pt">Course Wise Marks & Grade</span>
                                    </p>
                                </td>
                            </tr>
                                ...
                                <tr style="height:17.15pt; -aw-height-rule:exactly">
                                    ...
                                    <td
                                        ...
                                        <p style="margin-top:0.95pt; margin-bottom:0pt; line-height:12.55pt">
                                            <span
                                                style="font-family:'Century Gothic'; font-size:10.5pt">{{ $item->course_name }}</span>
                                        </p>
                                    </td>
                                    <td
                                    ...
                                    <td
                                        ...
                                        <p
                                            style="margin-top:0.95pt; margin-bottom:0pt; text-align:center; line-height:12.55pt">
                                            <span
                                                style="font-family:'Century Gothic'; font-size:10.5pt">{{ $marks }}</span>
                                        </p>
                                    </td>
                                    <td
                                        style="width:10%; border:0.75pt solid #08080c; padding-right:7.22pt; padding:4px; vertical-align:top; -aw-border:0.5pt single">
