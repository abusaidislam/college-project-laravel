...
@section('content')
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('departmenthistory.store') }}" enctype="multipart/form-data">
                                        @csrf()
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="name" name="name"
                                                    placeholder="Department Name" value="" maxlength="50"
                                                    required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label><strong>History :</strong></label>
                                            <textarea class="summernote" id="history" value="" name="history"></textarea>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <label><strong>Vission & Mission :</strong></label>
                                        <textarea class="summernote" id="vision" value="" name="vision"></textarea>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('departmenthistory.index') }}" + '/' + id + '/edit', function(data) {
        ...
        $('body').on('click', '#delete', function() {
            ...
            if (confirm("Are You sure want to delete This!")) {
                $.ajax({
                    type: "DELETE",
                    url: 'departmenthistory/' + id,
                    success: function(data) {
                        window.location = 'departmenthistory'
                    }
