                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <tbody id="list">
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('public/Staff/' . $ndata->photo) }} " alt=""
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal modal-lg"
                                        action="{{ route('degree_staff.store') }}" enctype="multipart/form-data">
                                        @csrf()
                                        <input type="hidden" name="depart_id" id="depart_id"
                                            value="{{ Session::get('depart_id') }}">
                                        <input type="hidden" name="id" id="id">
                                        @php
                                        $number = DB::table('degree_staff')
                                        ->select('serial_num')
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label for="serial_num" class="col-sm-12 control-label">Serial
                                                        Number</label>
                                                    <div class="col-sm-12">
                                                        <input type="number" class="form-control" id="serial_num"
                                                            name="serial_num" value="{{ $number->serial_num + 1 }}"
                                                            required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('degree_staff.index') }}" + '/' + id + '/edit', function(data) {
                $('#ajaxModel').modal('show');
