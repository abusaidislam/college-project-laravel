...
@section('content')
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Annual Committees Information</h2>
                    ...
                    <div class="x_content">
                        <h2 class="text-center">Buying Committee</h2>
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <tbody id="list">
                                            @foreach ($data as $ndata)
                                                <tr>
                                                    <td><img src="{{ asset('public/Annual_committees/' . $ndata->photo) }} "
                    ...
                    <div class="x_content">
                        <h2 class="text-center">Cultural Committee</h2>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <tbody id="list">
                                            @foreach ($data1 as $ndata1)
                                                <tr>
                                                    <td><img src="{{ asset('public/Annual_committees/' . $ndata1->photo) }}"
                                                            alt="" width="80" height="80"> </td>
                                                    <td>{{ $ndata1->name }}</td>
                                                    <td>{{ $ndata1->designation }} </td>
                                                    <td>{{ $ndata1->academic_designation }} </td>
                                                    <td>{{ $ndata1->bcs_batch }} </td>
                                                    <td>{{ $ndata1->department }} </td>
                                                    <td>{{ $ndata1->email }} </td>
                                                    <td>{{ $ndata1->mobile_no }} </td>

                                                    <td><button type="button" id="edit" data-id="{{ $ndata1->id }}"
                                                            class="btn btn-sm btn-info">Edit</button>

                                                        <button type="button" id="delete" data-id="{{ $ndata1->id }}"
                                                            class="btn btn-sm btn-danger">Delete</button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal"
                                        action="{{ route('annual.store') }}" enctype="multipart/form-data">
                                        @csrf()
                                        ...
                                        <div class="form-group">
                                            <label for="academic_designation" class="col-sm-12 control-label">Academic
                                                Designation</label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label for="Type" class="col-sm-12 control-label">Committee Type</label>
                                            <div class="col-sm-12">
                                                <select name="type" id="type">
                                                    <option value="1">Buying Committee </option>
                                                    <option value="2">Cultural Committee </option>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('annual.index') }}" + '/' + id + '/edit', function(data) {
