                                ...
                                <table class="table table-filter">
                                    <tbody>
                                        ...
                                        <tr data-status="pagado">
                                            <td>
                                                <div class="ckbox">
                                                    <a href="{{ url('/degree-sent-mail-delete/' . $ndata->id) }}"><button
                                            ...
                                            <td>
                                                ...
                                                @if ($ndata->status == 0)
                                                <a href="degree_maildetails/{{ $ndata->id }}"
                                                    style="color: blue;  "><b>{{ $ndata->subject }}...</b></a>
                                                @else
                                                <a href="degree_maildetails/{{ $ndata->id }}" style="color: black;">{{
                                                    $ndata->subject }}...</a>
                                                @endif
                                                <span class="media-meta pull-right">{{ date('M',
                                                    strtotime($ndata->created_at)) }}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" id="addform" name="form" class="form-horizontal"
                            action="{{ url('degree_email_store') }}" enctype="multipart/form-data">
                            @csrf()
                            ...
                            <div class="form-group "> <label> </label>
                                <div class="col-sm-12 pt-3">
                                    <label><input type="checkbox" name="alldepartment" id="alldepartment" value="1"
                                            onclick="myFunction()"> All Department</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="summernote" placeholder="Enter mail" id="mail"
                                        name="mail"></textarea>
        ...
        $('body').on('click', '#status', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    window.location = 'sentmaildetails/' + id;
                }
