...
@section('title', 'Teacher Council Manage |')
@section('content')
<div class="content">
      <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Teacher Council Information</h2>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form" class="form-horizontal modal-lg"
                                        action="{{ route('teachercouncil.store') }}" enctype="multipart/form-data">
                                        @csrf()
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <select class="form-control" id="designation" name="designation">
                                                            ...
                                                            <option class="" value="1">Secretary</option>
                                                            <option class="" value="2">Joint Secretary</option>
                                                            <option class="" value="3">Treasurer</option>
                                                        </select>
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            ...
            $.get("{{ route('teachercouncil.index') }}" + '/' + id + '/edit', function(data) {
                $('#ajaxModel').modal('show');
        ...
        $('body').on('click', '#delete', function() {
            ...
            Swal.fire(sweetAlertConfirmation).then((result) => {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: 'teachercouncil/' + id,
                        success: function(data) {
                            window.location = 'teachercouncil';
