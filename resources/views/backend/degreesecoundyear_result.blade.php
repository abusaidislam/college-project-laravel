...
@section('title', 'Student Result Secound Year Manage |')
@section('content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Student Result Secound Year</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li>
                                 <span class="input-group-btn">
                                    <a class="btn btn-primary " href="javascript:void(0)" id="exprotModel">Result List PDF
                                    </a>
                               </span>
                            </li>
                        </ul>
                                            ...
                                            @foreach ($Student as $ndata)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a target="_blank"
                                                            href="{{ url('degree-secound-year-marksheet', $ndata->registration_no) }}"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ route('degree-secound-year-result.store') }}"
                                        ...
                                        <div class="form-group">
                                            <label for="student_class_year" class="col-sm-12 control-label">
                                                Session</label>
                                                <div class="col-sm-12">
                    ...
                    <div class="modal fade" id="pdfModel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="form" name="form"
                                        action="{{ url('degree-secound-year-result-list/export-pdf') }}"
                                        enctype="multipart/form-data">
                                        @csrf()
                                        <input type="hidden" name="id" id="id">
                                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '#edit', function() {
            var id = $(this).data('id');
            $.get("{{ route('degree-secound-year-result.index') }}" + '/' + id + '/edit', function(data) {
