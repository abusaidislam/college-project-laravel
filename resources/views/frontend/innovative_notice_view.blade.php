            ...
            <div class=" col-md-2   col-sm-6 pt-3 p-0 m-0 pb-5  bg-dark ">
                ...
                <div class=" ps-2">
                    <i class="fa fa-caret-right"style="color:#089647; font-size:20px;"></i> <a
                        class=" text-light fw-bold text-uppercase " style="font-size:13px; font-family: Times new roman;   "
                        href=""> Innovative Notice</a>
                    <hr>
                </div>
                {{-- @endforeach --}}
                                        ...
                                        @foreach ($data as $ndata)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><a
                                                        href="{{ asset('public/innovativenotice/' . $ndata->file) }}"
