                            ...
                            <tbody> <?php $i = 0; ?>
                                @foreach ($data as $ndata)
                                    ...
                                    <tr>
                                        ...
                                        <td class="">{{ $ndata->issue_no }}</td>
                                        <td class="">{{ $ndata->subject }} </td>
                                        <td class="text-center">{{ $ndata->publish_date }} </td>
                                        <td class="text-center"><a href="public/upload/{{ $ndata->document }}" download
                                                class="btn btn-info ">
                                                <i class="fa fa-download"></i> Download
                                            </a> <a href="{{ asset('public/upload/' . $ndata->document) }}" target="_blank"
                                                class="btn btn-info ">
                                                view
                                            </a></td>
                                    </tr>
