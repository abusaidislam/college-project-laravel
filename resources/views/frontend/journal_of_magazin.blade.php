                ...
                <div class=" ps-2">
                    <ul style=" list-style: none;">
                        <li> <i class="fa fa-caret-right"style="color:#089647; font-size:20px;"></i> <a
                                ...
                                style="font-size:13px; font-family: Times new roman;" href="journals">Journal of Saadat
                                College</a>
                        </li>
                    ...
                    <ul style=" list-style: none;">
                        <li> <i class="fa fa-caret-right"style="color:#089647; font-size:20px;"></i> <a
                                ...
                                href="journals-of-magazin">Magazin</a>
                        </li>
                        ...
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <tbody>
                                        <?php $i = 0; ?>
                                        @foreach ($journalMagazin as $ndata)
                                            <?php $i++; ?>
                                            <tr>
