                                    ...
                                    <div class="col-lg-4">
                                        <div class="card shadow-sm">
                                            <div class="card-header bg-transparent text-center">
                                                <img class="profile_img" src="{{ asset('principal/' . $p1->photo) }}"
                                                    alt="student dp">
                                                <h3></h3>
                                            </div>
                                            <div class="card-body row">

                                                <p class="mb-0 px-5"><strong class="pr-1">Name :
                                                        {{ $p1->name }}</strong></p>
                                                <p class="mb-0 px-5"><strong class="pr-1">Designation :
                                                        {{ $p1->designation }}</strong></p>
                                                <p class="mb-0 px-5"><strong class="pr-1">Department :
                                                        {{ $p1->department }}</strong></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
