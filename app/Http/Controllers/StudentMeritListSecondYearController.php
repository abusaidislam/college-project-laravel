...
class StudentMeritListSecondYearController extends Controller
{
    public function index()
    {
        ...
        $classname = StudenClass::where('id', 2)->first();
        ...
        $studentsession = StudentHonoursSecoundYear::select('session_year')->where('class_id', $studentclass->id)->distinct()->get();
        Session::put('depart_id', $depart_id);
        Session::put('depart_name', $depart_name);
        return view('backend.studentmeritlistsecondyear', compact('depart_id','StudentMeritList','Course','depart_name','CourseName','classname','studentclass','studentsession'));
      }
    ...
    public function store(Request $request)
    {
        ...
        Session::put('depart_name', $depart_name);
         ...
         return redirect('second-year-merit-list')->with('massage', 'Inserted successfully!!!');
    ...
    public function StudentSecondmerit(Request $request){
    ...
    foreach ($Students as $value) {
     ...
     public function SecondMeritexportToPDF(Request $request)
     {
