...
class StudentMeritListPreliminaryToMastersController extends Controller
{
    public function index()
    {
        ...
        $Course   = CourseName::where('depart_id', '=', $depart_id)->where('class_id', 5)->orderby('name','asc')->get();
        ...
        $studentsession = StudentPreliminaryToMasters::select('session')->where('studentclass', $studentclass->id)->distinct()->get();
        Session::put('depart_id', $depart_id);
        Session::put('depart_name', $depart_name);
        return view('backend.studentmeritlistpreliminary', compact('depart_id','StudentMeritList','Course','depart_name','CourseName','classname','studentclass','studentsession'));
      }
    ...
    public function store(Request $request)
    {
        ...
        Session::put('depart_name', $depart_name);
         ...
         return redirect('preliminary-merit-list')->with('massage', 'Inserted successfully!!!');
    ...
    public function StudentPreliminarymerit(Request $request){
    ...
    public function PreliminaryMeritexportToPDF(Request $request)
     {
         ...
         $pdf = PDF::loadView('backend.studentmeritlistsecondyear_pdf', ['data' => $data, 'depart_id' => $depart_id]);
