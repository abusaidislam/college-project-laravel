...
class StudentMeritListFourthYearController extends Controller
{
    ...
    public function index()
    {
        ...
        $classname = StudenClass::where('id', 4)->first();
        ...
        $studentsession = StudentHonoursFourthYear::select('session_year')->where('class_id', $studentclass->id)->distinct()->get();
        Session::put('depart_id', $depart_id);
        Session::put('depart_name', $depart_name);
        return view('backend.studentmeritlistfourthyear', compact('depart_id','StudentMeritList','Course','depart_name','CourseName','classname','studentclass','studentsession'));
      }
    ...
    public function store(Request $request)
    {
        ...
        Session::put('depart_name', $depart_name);
         ...
         return redirect('fourth-year-merit-list')->with('massage', 'Inserted successfully!!!');
    ...
    public function StudentFourthmerit(Request $request){
    ...
    foreach ($Students as $value) {
     ...
     public function FourthMeritexportToPDF(Request $request)
     {
         ...
         $pdf = PDF::loadView('backend.studentmeritlistfourthyear_pdf', ['data' => $data, 'depart_id' => $depart_id]);
